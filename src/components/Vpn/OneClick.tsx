      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          >
            ...
            >
              Get instant, hassle-free VPN protection for<br/> all your devices.
            </ContentDescription>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] flex items-center justify-center"
          >
            <div className="relative w-full h-full">
              <Image
                src="/vpn/One-click.png"
                alt="One-click security"
                fill
