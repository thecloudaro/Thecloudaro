    ...
    <section className="relative overflow-hidden" style={{ backgroundColor: virtualMachineStyles.heroBg }}>
      <div className="relative z-10 flex min-h-[65vh] flex-col">
        <div className="flex flex-1 items-start">
          <div className="mx-auto flex w-full max-w-7xl flex-col gap-12 pl-0 sm:pl-0 lg:pl-0 pr-4 sm:pr-6 lg:pr-8 pt-16 sm:pt-20 lg:flex-row lg:items-start lg:gap-16 lg:pt-24">
            {/* Left Side - Text Content */}
            <div className="max-w-3xl space-y-6 lg:max-w-2xl pl-4 sm:pl-6 lg:pl-6 pt-4 sm:pt-6 lg:pt-8">
