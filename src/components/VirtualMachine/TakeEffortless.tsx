    ...
    <section className="relative overflow-hidden" style={{ backgroundColor: virtualMachineStyles.sectionBg }}>
      <div className="relative z-10 flex min-h-[65vh] flex-col">
        <div className="flex flex-1 items-start">
          <div className="mx-auto flex w-full max-w-7xl flex-col pl-0 sm:pl-0 lg:pl-0 pr-4 sm:pr-6 lg:pr-8 pt-16 sm:pt-20 lg:flex-row lg:items-center lg:gap-16 lg:pt-24">
            {/* Left Side - Image */}
            ...
            <div className="max-w-3xl space-y-4 lg:max-w-2xl pl-2 sm:pl-4 lg:pl-2 mt-16">
              <ContentHeading
