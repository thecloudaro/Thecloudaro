...
const SpacemailCard = () => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="ba-surface-spacemail bg-[hsl(var(--spacemail-card-bg))] rounded-2xl sm:rounded-3xl overflow-hidden h-auto lg:h-[500px] flex flex-col lg:flex-row gap-4 transition-all duration-500 ease-in-out touch-manipulation">
        {/* Left side - Content */}
        ...
        {/* Right side - Image */}
        <div className="w-full lg:w-1/2 order-first lg:order-none lg:h-full min-h-[220px] sm:min-h-[280px] lg:min-h-0 bg-gradient-to-br from-[hsl(var(--spacemail-card-gradient-from))] to-[hsl(var(--spacemail-card-gradient-to))] relative overflow-hidden">
          <Image
            src="/Home/Email.png"
            alt="Email Service"
            fill
