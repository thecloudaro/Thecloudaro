  ...
  const plans = [
    {
      ...
      pricing: {
        monthly: { price: 3.88, renewal: 3.88, original: 5.88, discountLabel: '31% OFF*', perMonth: 3.88 },
        yearly: { price: 19.88, renewal: 19.88, original: 28.88, discountLabel: '31% OFF*', perMonth: 1.66 },
        biyearly: { price: 34.88, renewal: 34.88, original: 48.88, discountLabel: '29% OFF*', perMonth: 1.45 }
      },
      popular: false,
      features: {
        cpu: '1x CPU',
    ...
    },
    {
      ...
      pricing: {
        monthly: { price: 4.88, renewal: 4.88, original: 6.88, discountLabel: '29% OFF*', perMonth: 4.88 },
        yearly: { price: 28.88, renewal: 28.88, original: 48.88, discountLabel: '41% OFF*', perMonth: 2.41 },
        biyearly: { price: 54.88, renewal: 54.88, original: 88.88, discountLabel: '38% OFF*', perMonth: 2.29 }
      },
      popular: true,
      features: {
        cpu: '2x CPU',
    ...
    },
    {
      ...
      pricing: {
        monthly: { price: 6.88, renewal: 6.88, original: 9.88, discountLabel: '30% OFF*', perMonth: 6.88 },
        yearly: { price: 38.88, renewal: 38.88, original: 68.88, discountLabel: '44% OFF*', perMonth: 3.24 },
        biyearly: { price: 72.88, renewal: 72.88, original: 118.88, discountLabel: '39% OFF*', perMonth: 3.04 }
      },
      popular: false,
      features: {
        cpu: '4x CPU',
      ...
      <div className="relative w-full pb-12 sm:pb-16 pt-12 sm:pt-16" style={{ backgroundColor: 'rgb(var(--hosting-section-bg))' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            ...
            {plans.map((plan, index) => {
              ...
              const originalSuffix = billingCycle === 'monthly' ? '/mo' : billingCycle === 'biyearly' ? '/2yr' : '/yr';
              const perMonthLabel =
                billingCycle === 'monthly'
                  ? `Renews for $${pricing.renewal.toFixed(2)}/mo`
                  : `$${pricing.perMonth.toFixed(2)}/mo`;
              const renewalSuffix = billingCycle === 'monthly' ? '/mo' : billingSuffix;
                  ...
                  <div className="space-y-6">
                    ...
                    {plan.popular && (
                      <div className="text-center">
                        <span className="text-sm font-semibold" style={{ color: 'rgb(var(--hosting-pick-popular-badge))' }}>
                          MOST POPULAR
                        </span>
                      </div>
                    )}
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm text-[rgb(var(--hosting-choose-text-gray-400))]">{plan.description}</p>
                    </div>
                    ...
                    <div className="text-center space-y-3 mb-8">
                      <div className="flex items-center justify-center gap-2 text-xs font-semibold">
                        ...
                        <span className="px-2 py-0.5 rounded-full text-[11px]" style={{ backgroundColor: 'rgba(var(--hosting-pick-discount-bg))', color: 'rgb(var(--hosting-accent-cyan))' }}>
                          {pricing.discountLabel}
                        </span>
                      </div>
                      <div className="text-[rgb(var(--hosting-text-white))] text-5xl font-bold tracking-tight">
                        ${pricing.price.toFixed(2)}
                        <span className="text-2xl font-semibold text-[rgb(var(--hosting-choose-text-gray-400))]">{billingSuffix}</span>
                      </div>
                      <div className="text-sm text-[rgb(var(--hosting-choose-text-gray-400))]">{perMonthLabel}</div>
                    </div>

                    {/* Features List */}
                    <div className="space-y-3 text-sm mt-20">
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">{plan.features.cpu}</div>
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">{plan.features.storage}</div>
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">
                        {plan.features.domains.startsWith('Unlimited') ? (
                          <strong className="text-[rgb(var(--hosting-text-white))]">{plan.features.domains}</strong>
                        ) : (
                          plan.features.domains
                        )}
                      </div>
                      <div className="text-[rgb(var(--hosting-text-white))] font-semibold">{plan.features.websites}</div>
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">
                        Secured by <span className="text-[rgb(var(--hosting-pick-text-green))]">SSL</span>
                      </div>
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">{plan.features.mailboxes}</div>
                      <div className="text-[rgb(var(--hosting-choose-text-gray-300))]">
                        Powered by <span className="text-[rgb(var(--hosting-pick-text-purple))]">SPACEMAIL®</span>
                      </div>
                      <div className="flex items-center gap-2 text-[rgb(var(--hosting-choose-text-gray-300))]">
                        Imunify360 Protection
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold" style={{ backgroundColor: 'rgb(var(--hosting-pick-popular-badge))', color: 'rgb(var(--hosting-pick-button-text))' }}>
                          NEW
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-[rgb(var(--hosting-choose-text-gray-300))]">
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-lg flex items-center justify-center border border-[rgb(var(--hosting-choose-border-gray-800))]">
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M8 2L2 6V14H14V6L8 2Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <span className="text-md text-[rgb(var(--hosting-choose-text-gray-400))]">+$0.88</span>
                              </div>
                            </div>
                          </div>
                          <button
                            ...
                            style={{
                              backgroundColor: selectedAddon ? 'rgb(var(--hosting-pick-addon-button-active))' : 'rgb(var(--hosting-pick-addon-button-bg))',
                    ...
                    <div>
                      <button
                        ...
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = 'rgb(var(--hosting-pick-button-bg))';
                        }}
                      >
                        Add to cart
                      </button>
                    ...
                    <div className="text-xs text-center text-[rgb(var(--hosting-choose-text-gray-400))]">
                      You pay ${pricing.price.toFixed(2)} — renews for ${pricing.renewal.toFixed(2)}{renewalSuffix}
                    </div>
                  </div>
                </motion.div>
              );
          ...
          <div className="mt-8 text-center">
            <p className="text-sm mb-4" style={{ color: 'rgb(var(--hosting-text-muted))' }}>
