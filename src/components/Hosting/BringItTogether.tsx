...
interface BringItTogetherProps {
  heading?: string;
  description?: string;
  buttonText?: string;
  buttonHref?: string;
...
const BringItTogether = ({
  heading = "Bring it all together",
  description = "Get free email accounts, SSLs, and create all the websites you need.",
...
export default BringItTogether;
