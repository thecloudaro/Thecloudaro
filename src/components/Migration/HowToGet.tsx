...
const HowToGet = () => {
  return (
    <section className="py-24" style={{ backgroundColor: 'rgb(var(--migration-howtoget-bg))', color: 'rgb(var(--migration-howtoget-text))' }}>
      <div className="mx-auto max-w-6.5xl px-6 sm:px-10">
        <div className="text-center space-y-6">
          ...
          >
            Check your cPanel backup file has all your website’s data, files, and
            databases<br/>from your current hosting environment.
          </ContentDescription>
        </div>
        ...
        <div className="mt-16 grid gap-8 items-center md:grid-cols-[minmax(0,0.8fr)_minmax(0,1fr)]">
          ...
          <div className="space-y-6 text-left">
            ...
            <ul className="space-y-8 list-disc list-outside text-base sm:text-2xl !text-[rgba(var(--migration-howtoget-list))]">
              ...
              <li>
                Choose “Download a Full Account Backup” then<br/>“Generate Backup”.
              </li>
              <li>
                When this has finished, download your cPanel backup<br/>file from
            ...
            <div>
              <Link
                href="#"
                className="inline-flex items-center gap-1 text-sm sm:text-sm font-semibold transition hover:underline"
                style={{ color: 'rgb(var(--migration-howtoget-link))' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = 'rgb(var(--migration-howtoget-link-hover))';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = 'rgb(var(--migration-howtoget-link))';
                }}
              >
                View full tutorial
                <span aria-hidden>
