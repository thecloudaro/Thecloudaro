...
const HighlyRated = () => {
  return (
    <section className="py-24" style={{ backgroundColor: 'rgb(var(--wp-highlyrated-bg))', color: 'rgb(var(--wp-highlyrated-heading))' }}>
      ...
      <div className="mx-auto mt-24 flex max-w-4xl flex-col items-center gap-16 px-6 sm:flex-row sm:items-center sm:justify-center sm:px-0 sm:gap-16" style={{ color: 'rgb(var(--wp-highlyrated-heading))' }}>
        <Image
