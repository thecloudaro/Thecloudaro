        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-1 w-full sm:w-auto flex items-center relative">
            ...
            <Input
              ...
              className="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(var(--domain-transfer-button-bg))] focus:border-transparent bg-domain-transfer-input border-domain-transfer-input text-[rgb(var(--hosting-text-white))] placeholder-domain-transfer-input"
              onKeyDown={(e) => {
                if (e.key === "Enter") {
                  handleTransfer();
                }
