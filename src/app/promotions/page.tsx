...
const promotions: PromotionCard[] = [
  {
    ...
    promoDescription: "Valid on new domain registrations only",
    promoCode: "WELCOME10",
  },
  {
    id: "2",
    productName: "Shared Hosting",
    promoName: "One-Time Discount",
    promoDescription: "New customers only (valid for the first 2 months)",
    promoCode: "LAUNCH-SH",
  },
  {
    id: "3",
    ...
    promoName: "Pay What We Pay",
    promoDescription: "Applicable on new SSL purchases",
    promoCode: "SECURE-NOW",
  },
  {
    id: "4",
