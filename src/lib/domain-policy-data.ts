export const domainPolicyData = {
  title: "Domain Registration Data Disclosure Policy & Guide",
  ...
  sections: [
    ...
    {
      id: "What Is Domain Registration Data",
      title: "2. What Is Domain Registration Data",
      content: [
    ...
    {
      id: "Public vs Non-Public Registration Data",
      title: "3. Public vs Non-Public Registration Data",
      subsections: [
        {
          id: "Public Data",
          title: "3.1 Public Data",
          content: [
        ...
        {
          id: "Non-Public (Redacted) Data",
          title: "3.2 Non-Public (Redacted) Data",
          content: [
    ...
    {
      id: "When We May Disclose Registration Data",
      title: "5. When We May Disclose Registration Data",
      subsections: [
        {
          id: "With Registrant Consent",
          title: "5.1 With Registrant Consent",
          content: ["Where the domain registrant has provided explicit consent for disclosure."],
        },
        {
        ...
        {
          id: "Legitimate Interest Requests",
          title: "5.3 Legitimate Interest Requests",
          content: [
    ...
    {
      id: "Data Request Evaluation Criteria",
      title: "6. Data Request Evaluation Criteria",
      content: [
    ...
    {
      id: "How to Submit a Data Disclosure Request (Guide)",
    ...
    {
      id: "Registrant Rights",
      title: "9. Registrant Rights",
      content: [
    ...
    },
    {
      ...
      title: "10. Data Security & Retention",
      content: [
    ...
    {
      id: "Abuse of Disclosure Requests",
      title: "11. Abuse of Disclosure Requests",
      content: [
    ...
    },
    {
      ...
      content: ["We may update this policy to reflect regulatory or policy changes. Updates will be published on our website."],
    },
    {
